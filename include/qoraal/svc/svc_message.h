...
#define SVC_MESSAGE_FLAG_0             ((uint16_t)(1U << (SVC_MESSAGE_FLAG_SHIFT + 0)))
#define SVC_MESSAGE_FLAG_1             ((uint16_t)(1U << (SVC_MESSAGE_FLAG_SHIFT + 1)))
#define SVC_MESSAGE_FLAG_2             ((uint16_t)(1U << (SVC_MESSAGE_FLAG_SHIFT + 2)))
#define SVC_MESSAGE_FLAG_3             ((uint16_t)(1U << (SVC_MESSAGE_FLAG_SHIFT + 3)))

#define SVC_MESSAGE_FLAG_MASK          ((uint16_t)(SVC_MESSAGE_FLAG_0 |         \
                                                   SVC_MESSAGE_FLAG_1 |         \
                                                   SVC_MESSAGE_FLAG_2 |         \
                                                   SVC_MESSAGE_FLAG_3))
...
#define SVC_MESSAGE_CLASS_EVENT        ((uint16_t)(1U << (SVC_MESSAGE_CLASS_SHIFT + 0)))
#define SVC_MESSAGE_CLASS_COMMAND      ((uint16_t)(1U << (SVC_MESSAGE_CLASS_SHIFT + 1)))
#define SVC_MESSAGE_CLASS_RESPONSE     ((uint16_t)(1U << (SVC_MESSAGE_CLASS_SHIFT + 2)))
#define SVC_MESSAGE_CLASS_LOG          ((uint16_t)(1U << (SVC_MESSAGE_CLASS_SHIFT + 3)))

#define SVC_MESSAGE_CLASS_MASK         ((uint16_t)(SVC_MESSAGE_CLASS_EVENT    | \
...
#define SVC_MESSAGE_SEVERITY_DEBUG     ((uint16_t)(1U << (SVC_MESSAGE_SEVERITY_SHIFT + 0)))
#define SVC_MESSAGE_SEVERITY_INFO      ((uint16_t)(1U << (SVC_MESSAGE_SEVERITY_SHIFT + 1)))
#define SVC_MESSAGE_SEVERITY_WARN      ((uint16_t)(1U << (SVC_MESSAGE_SEVERITY_SHIFT + 2)))
#define SVC_MESSAGE_SEVERITY_ERROR     ((uint16_t)(1U << (SVC_MESSAGE_SEVERITY_SHIFT + 3)))

#define SVC_MESSAGE_SEVERITY_MASK      ((uint16_t)(SVC_MESSAGE_SEVERITY_DEBUG | \
...
#define SVC_MESSAGE_QOS_LOW            ((uint16_t)(1U << (SVC_MESSAGE_QOS_SHIFT + 0)))
#define SVC_MESSAGE_QOS_NORMAL         ((uint16_t)(1U << (SVC_MESSAGE_QOS_SHIFT + 1)))
#define SVC_MESSAGE_QOS_HIGH           ((uint16_t)(1U << (SVC_MESSAGE_QOS_SHIFT + 2)))
#define SVC_MESSAGE_QOS_CRITICAL       ((uint16_t)(1U << (SVC_MESSAGE_QOS_SHIFT + 3)))

#define SVC_MESSAGE_QOS_MASK           ((uint16_t)(SVC_MESSAGE_QOS_LOW      |   \
                                                   SVC_MESSAGE_QOS_NORMAL   |   \
                                                   SVC_MESSAGE_QOS_HIGH     |   \
                                                   SVC_MESSAGE_QOS_CRITICAL))

#define SVC_MESSAGE_DEFAULT_FLAGS      ((uint16_t)(SVC_MESSAGE_CLASS_EVENT |     \
                                                   SVC_MESSAGE_QOS_NORMAL))
...
#define SVC_MESSAGE_SET_CLASS(message, class_bit)                               \
    do {                                                                        \
        (message)->flags &= (uint16_t)~SVC_MESSAGE_CLASS_MASK;                  \
        (message)->flags |= (uint16_t)(class_bit);                              \
    } while (0)

#define SVC_MESSAGE_SET_SEVERITY(message, severity_bit)                         \
    do {                                                                        \
        (message)->flags &= (uint16_t)~SVC_MESSAGE_SEVERITY_MASK;               \
        (message)->flags |= (uint16_t)(severity_bit);                           \
    } while (0)

#define SVC_MESSAGE_SET_QOS(message, qos_bit)                                   \
    do {                                                                        \
        (message)->flags &= (uint16_t)~SVC_MESSAGE_QOS_MASK;                    \
        (message)->flags |= (uint16_t)(qos_bit);                                \
    } while (0)

#define SVC_MESSAGE_ADD_FLAGS(message, bits)                                    \
    do {                                                                        \
        (message)->flags |= (uint16_t)(bits);                                   \
    } while (0)
